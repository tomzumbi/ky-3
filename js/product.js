function createProduct() {
    if (localStorage.getItem('products') == null) {
        let products = [{
            ...
            img: './img/products/nam-dui-ga-chay-toi.jpeg',
            category: 'Món mặn',
            price: 200000,
            ...
            },
            {
                ...
                img: './img/products/banh_lava_pho_mai_nuong.jpeg',
                category: 'Món mặn',
                price: 180000,
                desc: 'Rau củ quả theo mùa tươi mới xào với nước mắm chay, gia vị để giữ được hương vị ngọt tươi nguyên thủy của rau củ, một món nhiều vitamin và chất khoáng, rất dễ ăn.'
            },
            ...
            },
            {
                ...
                status: 1,
                title: 'Cơm chiên cua',
                img: './img/products/com_chien_cua.png',
                category: 'Món mặn',
                price: 280000,
...

            {
                ...
                img: './img/products/sup-bao-ngu-hai-sam.jpeg',
                category: 'Món mặn',
                price: 540000,
...

            {
                ...
                title: 'Tai cuộn lưỡi',
                category: 'Món mặn',
                img: './img/products/tai-cuon-luoi.jpeg',
                price: 340000,
...

            {
                ...
                category: "Nước uống",
                img: './img/products/tra-pho-mai-kem-sua.jpg',
                price: 34000,
            ...
            },
            {
                ...
                category: "Nước uống",
                img: './img/products/tra-dao-chanh-sa.jpg',
                price: 25000,
            ...
            },
            {
                ...
                img: './img/products/banh-chuoi-nuong.jpeg',
                price: 60000,
            ...
            },
            {
                ...
                img: './img/products/thit_nuong.jpg',
                category: 'Món mặn',
                price: 60000,
            ...
            },
            {
                ...
                img: './img/products/nom_ga_hoi_an.png',
                category: 'Món mặn',
                price: 60000,
            ...
            },
            {
                ...
                img: './img/products/set_bun_ca.jpg',
                category: 'Món mặn',
                price: 60000,
            ...
            },
            {
                ...
                img: './img/products/bun_ca_hanh_phi.jpeg',
                category: 'Món mặn',
                price: 60000,
                desc: 'Bún cá được làm đặc biệt hơn với cá trắm lọc xương và chiên giòn, miếng cá nhúng vào nước dùng ăn vẫn giòn dai, thơm ngon vô cùng'
            },
            {
                ...
                img: './img/products/tom_su_luot_ran_thit.png',
                category: 'Món mặn',
                price: 60000,
            ...
            },
            {
                ...
                img: './img/products/banh_cookie_dua.jpeg',
                category: 'Món mặn',
                price: 130000,
            ...
            },
            {
                ...
                img: './img/products/sot_mam_thai.jpeg',
                category: 'Món mặn',
                price: 130000,
                desc: 'Bánh cookie dừa ngọt vừa miệng, dừa bào tươi nhào bánh nướng giòn tan, cắn vào thơm lừng, giòn rụm'
            },
            {
                ...
                category: 'Món mặn',
                img: './img/products/tom-su-rang-muoi.jpeg',
                price: 550000,
            ...
            },
            {
                ...
                category: 'Món mặn',
                img: './img/products/tom-su-rang-bo-toi.jpeg',
                price: 550000,
...

            {
                ...
                category: 'Món mặn',
                img: './img/products/combo-vitquay-va-goivit.jpeg',
                price: 510000,
...

            {
                ...
                img: './img/products/set_ca_tam.jpg',
                category: 'Món mặn',
                price: 950000,
            ...
            },
            {
                ...
                status: 1,
                title: 'Chả ốc 1 phần',
                img: './img/products/cha_oc_1_phan.jpeg',
                category: 'Món mặn',
                price: 350000,
...

            {
                ...
                category: 'Món mặn',
                img: './img/products/ga-u-muoi-thao-moc.png',
                price: 450000,
...

            {
                ...
                category: 'Món mặn',
                img: './/img/products/ga-khong-loi-thoat.png',
                price: 520000,
...

            {
                ...
                category: 'Món mặn',
                img: './img/products/ca-chien-gion-mam-thai.jpeg',
                price: 350000,
...

            {
                ...
                category: 'Món mặn',
                img: './img/products/chan-gio-chien-gion-mam-thai.jpeg',
                price: 420000,
...

            {
                ...
                category: 'Món mặn',
                img: './img/products/vit-om-sau.jpeg',
                price: 350000,
...

            {
                ...
                category: 'Món mặn',
                img: './img/products/canh-dua-bo-ham.jpeg',
                price: 270000,
...

            {
                ...
                category: 'Món mặn',
                img: './img/products/nac-nong-heo-nuong-kem-xoi-trang.jpeg',
                price: 300000,
...

            {
                ...
                category: 'Món mặn',
                img: './img/products/thit-quay.jpeg',
                price: 280000,
...

            {
                ...
                title: 'Khâu nhục',
                category: 'Món mặn',
                img: './img/products/khau-nhuc.jpeg',
                price: 280000,
            ...
            },
            {
                ...
                title: 'Xíu mại tôm thịt ( 10 viên)',
                category: 'Món mặn',
                img: './img/products/ha_cao_tom_thit.jpg',
                price: 140000,
                desc: 'Những miếng há cảo, sủi cảo, hoành thánh với phần nhân tôm, sò điệp, hải sản tươi ngon hay nhân thịt heo thơm ngậy chắc chắn sẽ khiến bất kỳ ai thưởng thức đều cảm thấy rất ngon miệng.'
            },
            {
                ...
                category: 'Món tráng miệng',
                img: './img/products/che-com-la-dua.jpeg',
                price: 60000,
...

            {
                ...
                category: 'Món tráng miệng',
                img: './img/products/banh-bong-lan-chanh-day.jpeg',
                price: 50000,
...

            {
                ...
                title: 'Chè bưởi',
                category: 'Món tráng miệng',
                img: './img/products/che-buoi.jpeg',
                price: 50000,
            ...
            },
            {
                ...
                category: "Món lẩu",
                img: './img/products/lau-thai-tomyum.jpeg',
                price: 699000,
                desc: 'Lẩu Thái là món ăn xuất phát từ món canh chua Tom yum nổi tiếng của Thái Lan. Nước lẩu có hương vị chua chua cay cay đặc trưng. Các món nhúng lẩu gồn thịt bò, hải sản, rau xanh và các loại nấm.',
            },
            {
                ...
                category: "Món lẩu",
                img: './img/products/lau-thai-nam-chay.png',
                price: 550000,
            ...
            },
            {
                ...
                category: "Món chay",
                img: './img/products/dau-hu-xao-nam-chay.png',
                price: 220000,
            ...
            },
            {
                ...
                category: "Món chay",
                img: './img/products/bun-tron-chay.png',
                price: 75000,
            ...
            },
            {
                ...
                category: "Món chay",
                img: './img/products/bun-rieu-chay.png',
                price: 75000,
            ...
            },
            {
                ...
                category: "Món chay",
                img: './img/products/mien-xao-rau-cu-chay.png',
                price: 170000,
            ...
            },
            {
                ...
                category: "Món chay",
                img: './img/products/cuon-nam-chay.png',
                price: 120000,
            ...
            },
            {
                ...
                title: 'Chả quế chay',
                category: "Món chay",
                img: './img/products/cha-que-chay.png',
                price: 70000,
                desc: '',
            },
            {
            ...
            },
            {
                ...
                category: "Món ăn vặt",
                img: './img/products/banh-trang-tron.jpg',
                price: 20000,
            ...
            },
            {
                ...
                category: "Món ăn vặt",
                img: './img/products/banh-trang-nuong.jpg',
                price: 10000,
            ...
            },
            {
                ...
                category: "Món ăn vặt",
                img: './img/products/oc-thap-cam.jpg',
                price: 50000,
            ...
            },
            {
                ...
                category: "Món ăn vặt",
                img: './img/products/com-chay-cha-bong.jpg',
                price: 60000,
            ...
            },
            {
                ...
                category: "Món ăn vặt",
                img: './img/products/bot-chien.jpg',
                price: 49000,
            ...
            },
            {
                ...
                category: "Món ăn vặt",
                img: './img/products/goi-bo-kho.jpg',
                price: 60000,
            ...
            },
            {
                ...
                img: './img/products/hoanh_thanh.jpg',
                category: 'Món mặn',
                price: 130000,
                desc: 'Những miếng há cảo, sủi cảo, hoành thánh với phần nhân tôm, sò điệp, hải sản tươi ngon hay nhân thịt heo thơm ngậy chắc chắn sẽ khiến bất kỳ ai thưởng thức đều cảm thấy rất ngon miệng.'
            },
            {
                ...
                img: './img/products/nuoc-ep-dau-tay.jpg',
                category: 'Nước uống',
                price: 100000,
